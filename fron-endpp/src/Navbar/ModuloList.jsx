  ...
  return (
    <Container className="mt-5">
      <Row className="justify-content-between align-items-center">
        <Col>
          <h1 className="text-center">Modulo List</h1>
        </Col>
        <Col className="text-right">
          <Button variant="primary" onClick={handleShowAdd}>Add New Modulo</Button>
        </Col>
      </Row>
      {loading ? (
        ...
        <Table striped bordered hover className="mt-3">
          <thead className="thead-dark">
            <tr>
              ...
              <th className="text-center">Orden Menu</th>
              <th className="text-center">Fecha Creacion</th>
              <th className="text-center">Usuario Creacion</th>
              <th className="text-center">Fecha Modificacion</th>
              <th className="text-center">Usuario Modificacion</th>
            ...
            {modulos.length === 0 ? (
              ...
              modulos.map((modulo) => (
                <tr key={modulo.idModulo}>
                  ...
                  <td className="text-center">{modulo.nombre}</td>
                  ...
                  <td className="text-center">
                    <Button variant="warning" size="sm" className="mr-2" onClick={() => handleShowEdit(modulo)}>Edit</Button>
                  </td>
                </tr>
              ))
            )}
      ...
      <Modal show={showAddModal} onHide={handleCloseAdd}>
        <Modal.Header closeButton>
          <Modal.Title>Add New Modulo</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form onSubmit={handleFormSubmit}>
            ...
            <Button variant="primary" type="submit" className="mt-3">Add Modulo</Button>
          </Form>
        </Modal.Body>
      </Modal>
      ...
      <Modal show={showEditModal} onHide={handleCloseEdit}>
        <Modal.Header closeButton>
          <Modal.Title>Edit Modulo</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          {editModulo && (
            <Form onSubmit={handleEditFormSubmit}>
              ...
              <Button variant="primary" type="submit" className="mt-3">Update Modulo</Button>
            </Form>
          )}
        </Modal.Body>
      </Modal>
