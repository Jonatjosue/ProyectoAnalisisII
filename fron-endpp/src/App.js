    ...
    { authToken && (
            ...
            {showLinks ? (
             <>
               ...
               <li class="nav-link active" aria-current="page" ><Link to="/TipoSaldoCuenta">TipoSaldoCuenta</Link></li>
    ...
    <AuthProvider>
      ...
      <div>
        <Routes>
          ...
          <Route path="/TipoSaldoCuenta" element={<ProtectedRoute> <TipoSaldoCuenta /> </ProtectedRoute> } />
